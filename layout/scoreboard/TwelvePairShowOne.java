...
public class TwelvePairShowOne extends TwelvePairShower {

	@Override
	public void addTwelvePair(Scoreboard scoreboard,
			Participant voter, Participant receiver) {
		scoreboard.root.getChildren().remove(scoreboard.background);
		
		scoreboard.root.getChildren().add(RectangleBuilder.create()
	    		.width(1920)
	    		.id("background")
	    		.height(1080)
	    		.id("redBack")
	    		.fill(new ImagePattern(scoreboard.utilities.backgroundRed))
	    		.build());
		scoreboard.root.getChildren().add(RectangleBuilder.create()
				.x(0)
				.y(780)
		...
		Text receiveNation = TextBuilder.create()
			.x(500)
			.y(795)
		...
		Text receiveText = TextBuilder.create()
				.x(500)
				.y(850)
		...
		Text giverNation = TextBuilder.create()
				.x(500)
				.y(900)
		...
		ImageView recFlag = ImageViewBuilder.create()
				.image(receiver.getFlag())
				.x(400)
				.fitHeight(120)
				.fitWidth(230)
				.build();
		
		ImageView votFlag = ImageViewBuilder.create()
				.image(voter.getFlag())
				.x(1500)
				.fitHeight(120)
				.fitWidth(230)
